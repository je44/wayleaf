...
const MESSAGES = {
  "zh-CN": {
    ...
    videoPipHint: "点击 Chrome 工具栏中的 Wayleaf 图标，选择“视频小窗”，再选择页面中的可播放视频。",
  ...
  "zh-TW": {
    ...
    videoPipLabTitle: "視頻小窗",
    videoPipLabDescription: "為相容的 HTML5 影片開啟畫中畫。",
    videoPipLabel: "啟用視頻小窗",
    videoPipHint: "點擊 Chrome 工具列的 Wayleaf 圖標，選擇「視頻小窗」，再選取頁面中的可播放影片。",
  ...
  en: {
    ...
    videoPipHint: "Click the Wayleaf icon in the Chrome toolbar, choose Video mini-player, then select a playable video on the page.",
  ...
  ja: {
    ...
    videoPipHint: "Chrome ツールバーの Wayleaf アイコンをクリックし、動画ミニプレーヤーを選んでから、ページ内の再生可能な動画を選択します。",
  ...
  ko: {
    ...
    videoPipHint: "Chrome 도구 모음의 Wayleaf 아이콘을 클릭하고 동영상 미니 플레이어를 선택한 뒤 페이지의 재생 가능한 동영상을 선택하세요.",
  ...
  es: {
    ...
    videoPipHint: "Haz clic en el icono de Wayleaf en la barra de Chrome, elige Mini reproductor de vídeo y selecciona un vídeo reproducible en la página.",
  ...
  fr: {
    ...
    videoPipHint: "Cliquez sur l’icône Wayleaf dans la barre d’outils Chrome, choisissez Mini-lecteur vidéo, puis sélectionnez une vidéo lisible sur la page.",
  ...
  de: {
    ...
    videoPipHint: "Klicken Sie in der Chrome-Symbolleiste auf das Wayleaf-Symbol, wählen Sie Video-Miniplayer und anschließend ein abspielbares Video auf der Seite aus.",

...
const MESSAGES = {
  "zh-CN": {
    ...
    socialVideoExtractorDescription: "提取小红书笔记里的可播放视频。",
  ...
  "zh-TW": {
    ...
    socialVideoExtractorDescription: "提取小紅書筆記裡的可播放影片。",
  ...
  en: {
    ...
    socialVideoExtractorDescription: "Extract playable video from Xiaohongshu notes.",
  ...
  ja: {
    ...
    socialVideoExtractorDescription: "小紅書ノートの再生動画を抽出します。",
  ...
  ko: {
    ...
    socialVideoExtractorDescription: "샤오홍슈 노트의 재생 동영상 추출.",
  ...
  es: {
    ...
    socialVideoExtractorDescription: "Extrae vídeo reproducible de notas Xiaohongshu.",
  ...
  fr: {
    ...
    socialVideoExtractorDescription: "Extrait les vidéos lisibles des notes Xiaohongshu.",
  ...
  de: {
    ...
    socialVideoExtractorDescription: "Extrahiert abspielbare Videos aus Xiaohongshu-Notizen.",

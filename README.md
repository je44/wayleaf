...
<p align="center">
  ...
  <a href="https://github.com/je44/wayleaf/releases/download/v1.5/wayleaf-v1.5.0.zip">下载 v1.5.0</a>
</p>
...
1. 下载 [wayleaf-v1.5.0.zip](https://github.com/je44/wayleaf/releases/download/v1.5/wayleaf-v1.5.0.zip) 并解压。
